...
# Subject Appointment
def get_subject_appointment(status) -> str:
    return f"Bệnh viện Bưu Chính - Lịch hẹn của bạn đã được {status}"
        ...
        <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 20px; background-color: #f7f7f7;">
            <div style="max-width: 600px; margin: auto; background: #ffffff; padding: 30px; border-radius: 12px; box-shadow: 0 3px 10px rgba(0,0,0,0.1);">
                ...
                <div style="border-left: 4px solid #c31815; padding-left: 15px; margin-bottom: 25px;">
                    ...
                    <p style="margin: 10px 0 0 0; font-size: 16px;">Chúng tôi xin thông báo rằng lịch hẹn của bạn đã được <span style="color: #27bd09; font-weight: bold;">{status} thành công</span> với các thông tin sau:</p>
                </div>
                ...
                <div style="background-color: #f8f9fa; padding: 15px; border-radius: 8px; margin: 25px 0;">
                    <h4 style="margin: 0 0 10px 0; color: #495057;">Lưu ý quan trọng nếu đặt lịch:</h4>
